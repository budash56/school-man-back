...
export class AddGuardrails1760037856494 implements MigrationInterface {
  ...
  public async up(q: QueryRunner): Promise<void> {
    ...
    await q.query(`
      ...
      NOT VALID;
    `);
    await q.query(`ALTER TABLE public.timetable_slots VALIDATE CONSTRAINT chk_slot_time;`);
    ...
    await q.query(`
      ...
      NOT VALID;
    `);
    await q.query(`ALTER TABLE public.class_groups VALIDATE CONSTRAINT chk_cg_section_format;`);
  ...
  public async down(q: QueryRunner): Promise<void> {
    ...
    await q.query(`ALTER TABLE public.class_groups DROP CONSTRAINT IF EXISTS chk_cg_section_format;`);
    ...
    await q.query(`ALTER TABLE public.timetable_slots DROP CONSTRAINT IF EXISTS chk_slot_time;`);
